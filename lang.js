...
const LANGUAGES = {
    ...
    en: {
        ...
        cheerCol: 'Message',
        yearCol: 'Year',
        bestRateCol: 'Best Rate',
        statusCol: 'Status',
        totalAvg: 'Overall Avg',
        noData: 'Collecting...',
        thisMonthStats: 'Monthly Achievement',
        monthlyStats: 'Monthly Statistics',
        yearlyStats: 'Yearly History',
        goalTitle: 'My Goals & Reflection',
        goalLabel: 'Goals & Ambitions',
        reflectLabel: 'Reflection & Achievement',
        tipsTitle: 'Success & Time Management',
        tipsSuccess: 'Success Tips',
        tipsTime: 'Time Management',
        resetAll: 'Reset All Data',
        reminderAdd: 'Add Reminder',
        reminderList: 'Reminders',
        reminderMemoLabel: 'Memo',
        reminderToday: 'Today\'s Reminders',
        bgClick: 'Click background +',
        noTodos: 'No todos',
        noReminders: 'No reminders',
        expandStats: 'Expand Statistics (2~7)',
        ...
        nov_: 'Nov',
        dec_: 'Dec',
        alertNoScore: 'No score to save!',
        alertNoTodo: 'Please enter a todo!',
        alertMax5: 'Max 5 items.\nPlease delete existing items.',
        alertDeleteTodo: 'Delete this todo?',
        alertSaved: 'Saved! ✨',
        alertNoContent: 'No content to save!',
        alertCleared: 'Content cleared.',
        alertClearConfirm: 'Clear all content?',
        alertSaveError: 'Error saving data.',
        alertDateReq: 'Please select a date!',
        alertMemoReq: 'Please enter a memo!',
        alertReminderAdded: 'Reminder added! 🔔',
        alertDeleteReminder: 'Delete this reminder?',
        alertBgChanged: 'Background changed! 🌸',
        alertMicPerm: 'Microphone permission required.',
    ...
    ja: {
        ...
        totalAvg: '総平均スコア',
        noData: 'データ収集中',
        thisMonthStats: '今月の達成成績表',
        monthlyStats: '月別統計',
        yearlyStats: '年別履歴',
        goalTitle: '私の目標と振り返り',
        goalLabel: '今年の目標と抱負',
        reflectLabel: '振り返りと達成記録',
        tipsTitle: '成功と時間管理',
        tipsSuccess: '成功のコツ',
        tipsTime: '時間管理の原則',
        resetAll: 'データリセット',
        reminderAdd: 'リマインダー追加',
        reminderList: 'リマインダーリスト',
        reminderMemoLabel: 'メモ',
        reminderToday: '今日のリマインダー',
        bgClick: '背景写真クリック +',
        noTodos: 'タスクがありません',
        noReminders: 'リマインダーがありません',
        expandStats: '統計ページ展開 (2~7)',
        collapseStats: '統計ページを閉じる',
        ...
        nov_: '11月',
        dec_: '12月',
        alertNoScore: '保存するスコアがありません！',
        alertNoTodo: 'タスクを入力してください！',
        alertMax5: '最大5件まで。\n既存の項目を削除してください。',
        alertDeleteTodo: 'このタスクを削除しますか？',
        alertSaved: '保存されました！ ✨',
        alertNoContent: '保存する内容がありません！',
        alertCleared: '内容が消されました。',
        alertClearConfirm: 'すべての内容を消しますか？',
        alertSaveError: '保存中にエラーが発生しました。',
        alertDateReq: '日付を選択してください！',
        alertMemoReq: 'メモを入力してください！',
        alertReminderAdded: 'リマインダーが追加されました！ 🔔',
        alertDeleteReminder: 'このリマインダーを削除しますか？',
        alertBgChanged: '背景写真が変更されました！ 🌸',
        alertMicPerm: 'マイクの権限が必要です。',
    ...
    zh: {
        ...
        totalAvg: '总平均分数',
        noData: '数据收集中',
        thisMonthStats: '本月达成成绩',
        monthlyStats: '月度统计',
        yearlyStats: '年度历史',
        goalTitle: '我的目标与反思',
        goalLabel: '今年的目标与抱负',
        reflectLabel: '反思与达成记录',
        tipsTitle: '成功与时间管理',
        tipsSuccess: '成功技巧',
        tipsTime: '时间管理原则',
        resetAll: '重置所有数据',
        reminderAdd: '添加提醒',
        reminderList: '提醒列表',
        reminderMemoLabel: '备注',
        reminderToday: '今日提醒',
        bgClick: '点击背景 +',
        noTodos: '没有待办事项',
        noReminders: '没有提醒',
        expandStats: '展开统计 (2~7)',
        collapseStats: '收起统计',
        ...
        nov_: '11月',
        dec_: '12月',
        alertNoScore: '没有可保存的分数！',
        alertNoTodo: '请输入待办！',
        alertMax5: '最多5项。\n请删除现有项目。',
        alertDeleteTodo: '删除此待办？',
        alertSaved: '已保存！ ✨',
        alertNoContent: '没有可保存的内容！',
        alertCleared: '内容已清除。',
        alertClearConfirm: '清除所有内容？',
        alertSaveError: '保存时出错。',
        alertDateReq: '请选择日期！',
        alertMemoReq: '请输入备注！',
        alertReminderAdded: '提醒已添加！ 🔔',
        alertDeleteReminder: '删除此提醒？',
        alertBgChanged: '背景已更改！ 🌸',
        alertMicPerm: '需要麦克风权限。',
